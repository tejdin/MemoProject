...
```
7. Copiez-collez votre clé `ssh-rsa AAAA ... AQ== [nom de la clé]` dans le champ "Key" ("Clé") sur Giltab
8. Supprimez la date d'expiration
9. Cliquez sur le bouton "Add key" ("Ajouter la clé")
10. C'est terminé : vous recevez dans la foulée un mail vous indiquant qu'une clé ssh a été ajoutée.
